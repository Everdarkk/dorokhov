<script lang="ts">
  ...
  export let label           = 'swipe up'
  export let showLabel       = true
  export let appearDelay     = 3000
  export let appearDuration  = 1000
  export let size            = 48
...
>
  <div class="icon-wrap">
    <!-- Motion streak lines behind the finger -->
    <div class="motion-lines" aria-hidden="true">
      <svg class="motion-svg" viewBox="0 0 48 40" fill="none">
        <path class="mline ml-1" d="M14 38 Q14 20 18 4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        <path class="mline ml-2" d="M24 38 Q24 20 24 4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        <path class="mline ml-3" d="M34 38 Q34 20 30 4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
      </svg>
    </div>

    <!-- Finger sliding upward -->
    <div class="finger-wrap">
      <svg class="finger-svg" viewBox="0 0 48 72" fill="none">
        <rect x="17" y="10" width="14" height="9" rx="4" stroke="currentColor" stroke-width="1.5" opacity="0.45"/>
        <rect x="13" y="8" width="22" height="50" rx="11" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        <line x1="15" y1="38" x2="33" y2="38" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.4"/>
      </svg>
    </div>
  </div>
  ...
  <div class="arrows" aria-hidden="true">
    <svg class="arrow arrow-2" viewBox="0 0 24 12" fill="none">
      <polyline points="2,10 12,2 22,10" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
...
<style>
  ...
  .swipe-hint.visible { opacity: 1; transform: translateY(0); }
  ...
  .finger-svg { width: var(--size); height: calc(var(--size) * 1.5); display: block; }
  ...
  .arrows { display: flex; flex-direction: column; align-items: center; gap: 3px; }
